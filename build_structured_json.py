...
Input source: debug/compare/<stem>_pdfplumber.txt and *_docling.txt (already
generated by compare_pdf_extractors.py with --save-text).

Usage:
  python build_structured_json.py --stem 63ΤΛ46Ψ842-Ξ2Μ
  (or) python build_structured_json.py --pdf data/Athens/63ΤΛ46Ψ842-Ξ2Μ.pdf
Outputs:
  debug/compare/<stem>_pdfplumber_structured.json
  debug/compare/<stem>_docling_structured.json
"""
